  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed pointer-events-none z-[9998] w-10 h-10 rounded-full border border-white mix-blend-difference transition-transform duration-300"
      />
      {/* Dot — instant */}
      <motion.div
        style={{
        ...
        className="fixed pointer-events-none z-[9999] w-1.5 h-1.5 rounded-full bg-white mix-blend-difference"
      />
    </>
  );
}
